...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
	{
       ...
       $this->configs = array(
            ...
            'YBC_FOOTER_LINK_CUSTOM' => array(                
                'label' => $this->l('Custom link block'),
                'type' => 'textarea',
                'lang' => true,
            ...
            'YBC_TC_COPYRIGHT_TEXT' => array(                
                ...
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',                
                'default' => 'Copyright 2017 <a href="#">E-Business Co., LTD.</a>  All rights reserved<br />Website is developed by <a class="_blank" href="http://www.etssoft.net">ETS-Soft</a>. All images used in the demo website are for preview purpose only and not included in the download file.',
            ), 
            ...
            'YBC_TC_CONTACT_FORM_LAYOUT' => array(
				...
				'options' => array(
                     ...
                     'id' => 'id_option',
        			 'name' => 'name'  ,
                     'desc' => $this->l('Setting email, phone number, address: Shop parameters -> Contact'),
                ),    
    ...
    public function hookDisplayFooter()
    {
        ...
        $moduleDirl = (Configuration::get('PS_SSL_ENABLED') && Configuration::get('PS_SSL_ENABLED_EVERYWHERE') ? 'https://' . $this->context->shop->domain_ssl : 'http://' . $this->context->shop->domain) . $this->context->shop->getBaseURI();
        $this->smarty->assign(array(
                'tc_display_panel' => $tc_display_panel,
                'tc_comparison_link' => $this->context->link->getPageLink('products-comparison'),
                'moduleDirl' => $moduleDirl.'modules/'.$this->name.'/',
